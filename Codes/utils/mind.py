...
class MIND(Dataset):
    ...
    def __init__(self, hparams, news_file, behaviors_file, shuffle_pos=False, validate=False):
        ...
        if len(hparams['attrs']) > 1:
            self.vocab = getVocab('data/dictionaries/vocab_whole.pkl')
        else:
            self.vocab = getVocab('data/dictionaries/vocab_title.pkl')
        ...
        for impr_index in self.impr_indexes:
            ...
            for news in impr:
                ...
                if self.bert:
                    ...
                    clicked_title_pad = [(self.title_size - i[0])*[1] + i[0]*[0]
